...
namespace DevUtil.Plugins.WorkLog
{
	/// <summary>
	/// Interaction logic for WorkLogControl.xaml
	/// </summary>
	public partial class WorkLogControl : UserControl, IPluginUserControl
	{
        public string PluginName { get { return "업무일지"; } }
        public string Description { get { return "일일 업무 기록 및 관리"; } }
